...
module.exports = {
    ...
    entry: {
        ...
        'js/broken-link-detector': './source/js/broken-link-detector.ts', // Changed from .js to .ts
        'js/mce-broken-link-detector': './source/mce/mce-broken-link-detector.ts' // Changed from .js to .ts
    },
